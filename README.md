...
```
- ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **✅ Реализовано (100%):**

- ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **├── Аутентификация**
- ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **├── Управление пользователями**
- ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **├── Компании (CRUD)**
- ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **├── Базы знаний (CSV/Excel)**
- ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **├── Медиа (Cloudinary)**
- ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **├── Подписки (Stripe (заглушка на фронт-енде))**
- ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **├── WhatsApp (WAHA)**
- ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **├── Google Calendar**
- ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **├── OAuth (Google, Facebook)**
- ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **├── Email (заглушка под реальный SMTP, надо доработать, пока приходит просто код в терминал)**
- ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **├── Админ панель**
- ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **├── Менеджерский функционал**
- ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **└── Frontend (полный UI)**
...
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Довести до конца механизм подключения **WhatsApp** к аккаунту клиента через WAHA (полный рабочий цикл: сессия → прием/отправка → привязка к компании).**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Реализовать подключение **Instagram и Facebook** через **Meta for Developers** (алгоритм авторизации/связки аккаунтов, дальнейшая работа с сообщениями).**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Реализовать механизм подключения **Gmail** (Email-канал).**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Реализовать подключение **Telegram** (учесть, что для нового подключения может требоваться отдельный workflow).**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Реализовать подключение **TikTok**.**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Доработать раздел **Integrations**: показывать пользователю только те интеграции, которые он выбрал/активировал (остальные не отображать и не давать подключать).**

### Календарь (доставка и запись)
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Подключить **Google Calendar API**.**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Для **Product**: реализовать календарь доставок (дата/слоты) + привязка к городу/адресу; правило «сначала оплата → потом запись в календарь».**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Для **Service**: реализовать календарь записи на услугу (дата/время/длительность/формат); правило «сначала предоплата → потом запись в календарь»; если услуга бесплатная — запись без оплаты.**

### Платежи и биллинг
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Реализовать биллинг подписок для бизнесов через **Stripe** (это отдельная сущность/логика, не путать с оплатой клиентом товаров/услуг).**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Реализовать **Stripe Connect**, чтобы бизнесы могли подключаться как marketplace через основной Stripe-аккаунт платформы (перераспределение платежей клиентам бизнеса через платформу).**

### Связка SaaS с n8n и внутренняя архитектура
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Связать существующий бэкенд SaaS с **n8n**: при создании компании/каналов должны корректно появляться/обновляться нужные credentials/настройки/узлы.**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Перед внедрением: изучить текущие workflows и определить, что именно должно меняться при создании новой компании и новых подключений.**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Реализовать механизмы создания новых подключений в n8n и бэкенде для всех соцсетей с учетом различий по каналам (например, Telegram может требовать отдельный workflow, WhatsApp — нет).**

### Интерфейс и продуктовые разделы
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Полностью разработать **Conversations**: удобный список диалогов, фильтры по каналам, детализация истории сообщений.**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Реализовать логи покупок и статусы оплат в интерфейсе SaaS (аналог текущих логов в Notion, но на нормальном фронте).**

### Менеджеры, поддержка и FAQ
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Реализовать механизм общения **менеджер ↔ бизнес** внутри SaaS (чат).**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Реализовать модель прав и закрепления: у бизнеса не больше 1 менеджера; у менеджера может быть много клиентов; один и тот же клиент не может принадлежать двум менеджерам.**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Сделать отдельного бота для ответов на **часто задаваемые вопросы** (FAQ).**

### Настройка поведения ассистента
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Реализовать раздел пользовательских настроек поведения (кастомные промпты/правила общения) как альтернативу fine-tuning: хранение, применение в сценариях, управление на уровне компании/канала/сценария.**

### Доработка логина через Google
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - Доработать логин и аутентификацию через Google для входа в аккаунт и для привязки Cloudinary. Сейчас реализована заглушка в виде кода, который приходит в терминал, можно пока так тестить.**
...
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - все связи и credentials/ноды в n8n,**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - все базы знаний/таблицы в Supabase,**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - папки и медиа в Cloudinary,**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - токены и ключи в SystemData,**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - историю чатов в MongoDB,**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - подписку Stripe (и связанные сущности),**
- Stripe Connect (disconnect) и все связанные данные,
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - все соединения со всеми соцсетями (WAHA-сессии, Meta-токены и т.д.).**
...
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - сбор и расчет метрик на backend на основе данных из баз данных и Stripe,**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - API для отдачи метрик во FrontEnd,**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - разделение метрик по бизнесу/компании и по каналам,**
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png) **❌ - учет источников лидов (включая TikTok → WhatsApp) в аналитике.**
...
- ![#ff8c00](https://placehold.co/15x15/ff8c00/ff8c00.png) **🔄 Текущее состояние: ориентировочно готово на ~50%, требуется довести до стабильной эксплуатации.**
...
|-----------|--------|-----|
| WhatsApp | ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **✅ Полная** | WAHA HTTP API |
| Telegram | ![#ff8c00](https://placehold.co/15x15/ff8c00/ff8c00.png) **🔄 В разработке** | Telegram Bot API |
| Instagram | ![#ff8c00](https://placehold.co/15x15/ff8c00/ff8c00.png) **🔄 В разработке** | Instagram Graph API |
| Facebook | ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **✅ OAuth готов** | Facebook Graph API |
| Email | ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **✅ Готов** | SMTP |
| TikTok | ![#ff8c00](https://placehold.co/15x15/ff8c00/ff8c00.png) **🔄 В разработке** | TikTok API |
| Google Calendar | ![#c5f015](https://placehold.co/15x15/c5f015/c5f015.png) **✅ Полная** | Google Calendar API |
