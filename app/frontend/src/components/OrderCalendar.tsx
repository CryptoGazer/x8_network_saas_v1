...
const demoCompanies: Company[] = [
  { id: 'PROD001', name: 'Product Hotel Canarian', type: 'Product', status: 'Active' },
  { id: 'SERV001', name: 'Service AI Agent', type: 'Service', status: 'Active' }
];
...
const demoOrders: OrderEvent[] = [
  {
    ...
    source: 'WhatsApp',
    source_row_ref: 'plink_WA1',
    company_id: 'PROD001',
    company_name: 'Product Hotel Canarian',
    order_id: 'plink_WA1',
    client_name: 'John Doe',
    contact: '+34612345678',
    items_summary: 'Private Boat Tour, 2h, 120 EUR',
    total_sum: 120,
    order_status: 'paid',
    scheduled_datetime: '2025-12-08T14:00:00.000+00:00',
    timezone: 'Europe/Madrid',
    created_at: '2025-11-22T12:30:00.000+00:00',
    created_by: 'auto',
    google_calendar_sync_status: 'ok:2025-11-22',
    google_calendar_event_id: 'gcal_evt_001',
    synced_to_google_calendar: true,
    notes: 'Auto-created from Conversation Center',
    sync_attempts_log: [
      {
        timestamp: '2025-11-22T12:35:00.000+00:00',
        outcome: 'ok',
  ...
  },
  {
    ...
    source: 'Instagram',
    source_row_ref: 'plink_IG2',
    company_id: 'PROD001',
    company_name: 'Product Hotel Canarian',
    order_id: 'plink_IG2',
    client_name: 'adventure_club',
    contact: '@adventure_club',
    items_summary: 'Advanced Diving Course, 2 days, 320 EUR',
    total_sum: 320,
    order_status: 'paid',
    scheduled_datetime: '2025-12-15T09:00:00.000+00:00',
    timezone: 'Europe/Madrid',
    created_at: '2025-11-23T10:00:00.000+00:00',
    created_by: 'auto',
    google_calendar_sync_status: 'never',
    google_calendar_event_id: null,
    synced_to_google_calendar: false,
    notes: 'Awaiting Google Calendar sync',
    sync_attempts_log: []
  },
  {
    order_calendar_id: 'oc_003',
    source: 'Manual',
    source_row_ref: '',
    company_id: 'SERV001',
    company_name: 'Service AI Agent',
    order_id: 'manual_001',
    client_name: 'Maria Garcia',
    contact: 'maria@example.com',
    items_summary: 'Business Strategy Consultation, 3h',
    total_sum: 450,
    order_status: 'paid',
    scheduled_datetime: '2025-12-10T10:00:00.000+00:00',
    timezone: 'Europe/Madrid',
    created_at: '2025-11-24T09:00:00.000+00:00',
    created_by: 'manual',
    google_calendar_sync_status: 'error:Invalid calendar token',
    google_calendar_event_id: null,
    synced_to_google_calendar: false,
    notes: 'Manual entry - requires reauth',
    sync_attempts_log: [
      {
        timestamp: '2025-11-24T09:05:00.000+00:00',
        outcome: 'error',
        message: 'Invalid calendar token. Please reauthenticate in Integrations.',
        actor: 'demo@example.com',
        attempt_id: 'attempt_002'
      },
      {
        timestamp: '2025-11-24T09:10:00.000+00:00',
        outcome: 'error',
        message: 'Invalid calendar token. Please reauthenticate in Integrations.',
        actor: 'demo@example.com',
